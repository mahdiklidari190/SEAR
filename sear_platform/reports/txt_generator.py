...
# This module generates a comprehensive, human-readable plain text (TXT) report.
# It is designed for quick scanning, terminal output, or simple text-based sharing,
# organizing all critical SEO findings into clearly defined, prioritized sections.
from __future__ import annotations

# Import the core data models containing the extracted SEO metrics and analysis results.
...
class TXTReportGenerator:
    """Generate comprehensive, well-formatted TXT reports for quick review."""
    ...
    def generate(
        ...
        """
        Assemble all analysis data into a structured, easy-to-read plain text report.
        ...
        Returns:
            A fully formatted string containing the complete text-based SEO report.
        """
        # =========================================================================
        # 1. ISSUE PRIORITIZATION & CATEGORIZATION
        # Sort all detected issues by severity to ensure the most critical problems 
        # are addressed first. Then, group them into actionable buckets.
        # =========================================================================
        ...
        # Identify "Quick Wins": issues that are easy to fix and require minimal time,
        # providing a high return on investment for immediate SEO improvements.
        quick_wins = [i for i in issues_sorted if i.difficulty == "Easy" and i.fix_time in ["2 mins", "5 mins", "10 mins"]]

        # Format the competitor list into a clean, readable string.
        comp_str = "\n".join([f"• [#{c.rank}] {c.url} | Title: {c.title[:50]}..." for c in competitors]) or "No competitors found."

        # =========================================================================
        # 2. OPTIONAL INTEGRATION SECTIONS
        # Conditionally build the Search Console and Analytics sections only if 
        # the data was successfully fetched and is available.
        # =========================================================================
        sc_section = ""
...
"""
        ...
        # =========================================================================
        # 3. MAIN REPORT ASSEMBLY
        # Construct the final report using a multi-line f-string for clean formatting.
        # Use fallback values (e.g., 'MISSING', 'None') to ensure the report remains 
        # readable even when specific data points are absent.
        # =========================================================================
        report = f"""========================================================================
